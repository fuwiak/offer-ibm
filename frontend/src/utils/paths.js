...
export default {
  ...
  github: () => {
    return "https://github.com/Mintplex-Labs/av-elia-bot";
  },
  discord: () => {
  ...
  settings: {
    ...
    userWorkspaces: () => {
      return `/settings/user-workspaces`;
    },
    userWorkspaceInstructions: (slug) => {
      return `/settings/user-workspaces/${slug}/instructions`;
    },
    userWorkspaceFiles: (slug) => {
      return `/settings/user-workspaces/${slug}/files`;
    },
    workspacesNew: () => {
      return `/settings/workspaces/new`;
    },
    chats: () => {
