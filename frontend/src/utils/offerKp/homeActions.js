...
export const HOME_CHAT_PROMPTS = {
  ...
  quote:
    "Подготовь коммерческое предложение (КП) для клиента: укажи позиции из каталога purolat.com, количество, валюту и НДС. Сформируй документ для превью в правой панели.",
  commission:
