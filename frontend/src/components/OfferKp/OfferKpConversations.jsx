...
export default function OfferKpConversations() {
  ...
  return (
    <div className="offerKp-conversations flex flex-col flex-1 min-h-0 overflow-hidden mt-2 pt-2 border-t border-theme-sidebar-border">
      <p className="offerKp-conversations__label px-2 mb-2 shrink-0">
