...
/**
 * Human-readable status for an in-progress (streaming) upload.
 * @param {{stage?: string, pageNumber?: number, totalPages?: number}|null} progress
 * @returns {string}
 */
function progressLabel(progress) {
  if (!progress) return "Uploading...";
  if (progress.stage === "ocr" && progress.totalPages) {
    return `Распознавание: стр. ${progress.pageNumber}/${progress.totalPages}`;
  }
  switch (progress.stage) {
    case "uploaded":
      return "Загружено, обработка...";
    case "loading":
      return "Чтение документа...";
    case "ocr":
      return "Распознавание текста...";
    case "ocr-deferred":
      return "Подготовка AI-распознавания...";
    case "vision-ocr":
      return "AI-распознавание таблицы...";
    case "vision-ocr-queued":
      return "В очереди на AI-распознавание...";
