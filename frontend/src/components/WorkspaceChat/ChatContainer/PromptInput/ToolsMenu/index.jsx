...
export default function ToolsMenu({
  ...
  useEffect(() => {
    if (showing && TABS.length > 0) setActiveTab(TABS[0].key);
  }, [showing, TABS]);
    ...
    <button
      ...
      className={
        offerKpHome
          ...
          : `border-none cursor-pointer hover:bg-zinc-700/50 light:hover:bg-slate-100 px-1.5 py-0.5 rounded text-[10px] font-medium text-center whitespace-nowrap ${
              active
