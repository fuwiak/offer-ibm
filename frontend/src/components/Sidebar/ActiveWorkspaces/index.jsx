                      ...
                      <div className="flex gap-x-2 items-center justify-between">
                        <Link
                          ...
                          className={`
                            ...
                            ${isActive ? "light:bg-[#efe9de] font-bold" : "hover:bg-theme-sidebar-subitem-hover light:hover:bg-[#f5f0e8]"}
                          `}
                        >
                          <div className="flex flex-row justify-between w-full items-center">
                            ...
                            >
                              <DotsSixVertical
                                size={20}
                                className={`${isActive ? "text-white light:text-theme-text-primary" : ""}`}
                                weight="bold"
                              />
                            </div>
                            <div
                            ...
                            >
                              <div className="w-[130px] overflow-hidden">
                                <p
                                  ...
                                  ${isActive ? "font-bold text-white light:text-theme-text-primary" : "font-medium "} truncate
                            ...
                            {user?.role === "admin" && (
                              ...
                              >
                                <button
                                  ...
                                  className={`group/upload border-none rounded-md flex items-center justify-center ml-auto p-[2px] ${isActive ? "hover:bg-zinc-500 light:hover:bg-[#e8e0d2]" : "hover:bg-zinc-500 light:hover:bg-slate-400"}`}
                                >
                                  <UploadSimple
                                    className={`h-[20px] w-[20px] ${isActive ? "text-zinc-400 hover:text-white light:text-[#6c6a64] light:group-hover/upload:text-theme-text-primary" : "text-zinc-400 hover:text-white light:text-slate-600 light:group-hover/upload:text-slate-950"}`}
                                  />
                                </button>
                                <button
                                  onClick={(e) => {
                                  ...
                                  className={`group/gear rounded-md flex items-center justify-center ml-auto p-[2px] ${isActive ? "hover:bg-zinc-500 light:hover:bg-[#e8e0d2]" : "hover:bg-zinc-500 light:hover:bg-slate-400"}`}
                                ...
                                >
                                  <GearSix
                                    ...
                                    className={`h-[20px] w-[20px] ${isActive ? "text-zinc-400 hover:text-white light:text-[#6c6a64] light:group-hover/gear:text-theme-text-primary" : "text-zinc-400 hover:text-white light:text-slate-600 light:group-hover/gear:text-slate-950"}`}
                                  />
                                </button>
                              </div>
                            )}
