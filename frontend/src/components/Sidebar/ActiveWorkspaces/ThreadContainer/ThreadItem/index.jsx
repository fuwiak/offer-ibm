    ...
    >
      ...
      >
        {thread.deleted ? (
          ...
          <div className="w-full pl-2 py-1 flex items-center gap-1">
            <input
              ref={renameInputRef}
              type="text"
              value={renameValue}
              ...
              className="w-full h-6 px-2 text-xs rounded border border-primary-button bg-transparent text-theme-text-primary focus:outline-none"
            />
            <button
              type="button"
              className="border-none bg-transparent text-theme-text-secondary hover:text-theme-text-primary p-1"
            ...
            {ctrlPressed ? (
              ...
              <div className="flex items-center w-fit md:invisible md:group-hover/thread:visible md:group-focus-within/thread:visible gap-x-1">
                <button
                  type="button"
                  className="border-none"
                  onClick={() => onTogglePin?.(thread.slug)}
                  aria-label={pinned ? "Unpin thread" : "Pin thread"}
                >
                  <PushPin
                    className={`${pinned ? "text-primary-button" : "text-slate-300 light:text-theme-text-secondary"} hover:text-white hover:light:text-theme-text-primary`}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-sm">{pinned ? "Unpin" : "Pin"}</p>
      </button>
      <button
