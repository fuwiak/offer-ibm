...
const Layout = ({ children }) => {
  ...
  return (
    <div
      ...
      className={`relative md:ml-[2px] md:mr-[16px] md:my-[16px] bg-theme-bg-secondary light:border-[1px] light:border-theme-sidebar-border w-full h-full overflow-y-scroll lawyerRevizorro-chat-shell ${showScrollbar ? "show-scrollbar" : "no-scroll"}`}
    >
      {children}
    </div>
  );
