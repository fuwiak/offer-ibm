  ...
  return (
    <div className="relative" ref={rootRef}>
      <button
        type="button"
        onClick={toggle}
        className="lawyerRevizorro-notifications-bell border-none bg-transparent p-2 cursor-pointer text-theme-text-primary hover:bg-theme-sidebar-item-hover relative"
        aria-label={t("layout.notifications")}
        aria-expanded={open}
      >
        <Bell size={22} weight={unreadCount > 0 ? "fill" : "regular"} />
        {unreadCount > 0 && (
          <span className="lawyerRevizorro-notifications-bell__badge" aria-hidden>
      ...
      {open && (
        <div
          className="lawyerRevizorro-notifications-dropdown"
          role="dialog"
          aria-label={t("layout.notifications")}
        >
          <div className="lawyerRevizorro-notifications-dropdown__header">
            <div>
              <p className="lawyerRevizorro-document-panel__eyebrow mb-0">
          ...
          <div className="lawyerRevizorro-notifications-dropdown__list">
            {preview.length === 0 ? (
              ...
              preview.map((n) => (
                <div
                  key={n.id}
                  className={`lawyerRevizorro-notifications-dropdown__item ${
                    !n.read ? "lawyerRevizorro-notifications-dropdown__item--unread" : ""
                  }`}
                >
          ...
          <Link
            ...
            onClick={() => setOpen(false)}
            className="lawyerRevizorro-notifications-dropdown__footer"
          >
