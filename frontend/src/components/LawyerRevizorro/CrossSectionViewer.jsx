...
const CROSS_SECTIONS = {
  ...
  "laminated": {
    name: "lawyer-revizorro Laminated",
    ug: "0.4 W/m²·K",
    thickness: "10.8 mm",
    layers: [
...
const PRODUCT_IDS = LAWYER_REVIZORRO_PRODUCTS.map((p) => p.id);
    ...
    <div className="flex flex-col gap-3 text-xs">
      ...
      <div className="flex flex-wrap gap-1">
        {LAWYER_REVIZORRO_PRODUCTS.map((p) => (
          ...
          >
            {p.name.replace("lawyer-revizorro ", "")}
          </button>
        ))}
      </div>
