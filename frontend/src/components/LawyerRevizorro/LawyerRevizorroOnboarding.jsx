    ...
    steps: [
      {
        ...
        body: "You have full control over the lawyer-revizorro platform. Access the dashboard at /lawyerRevizorro-dashboard to monitor KPIs, quotes, and the sales pipeline.",
        icon: "📊",
      },
      {
      ...
      },
      {
        ...
        body: "Set Claude as the LLM provider under Settings → LLM Preference. Create an 'lawyerRevizorro-public' workspace for the public bot.",
        icon: "🤖",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        body: "Your personalised lawyer-revizorro price list is available in the chat. Ask 'Show me my price list' to get your tier pricing.",
        icon: "💶",
      },
      {
    ...
    steps: [
      {
        ...
        body: "Ask anything about lawyer-revizorro products, technical specifications, and availability. The bot adapts to your role automatically.",
        icon: "💬",
      },
    ],
  },
...
const STORAGE_KEY = "lawyerRevizorro_onboarding_seen";
const ROLE_LABELS = {
  admin: "Admin",
  partner: "Partner",
...
export function useLawyerRevizorroOnboarding() {
...
export default function LawyerRevizorroOnboarding({ onDone }) {
  const { role } = useLawyerRevizorroRole();
  const { user } = useUser();
