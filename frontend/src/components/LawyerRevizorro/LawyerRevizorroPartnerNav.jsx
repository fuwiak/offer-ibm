...
export default function LawyerRevizorroPartnerNav() {
  ...
  return (
    <nav className="lawyerRevizorro-partner-nav flex flex-col shrink-0">
      <div className="flex flex-col">
        <Link
          to={paths.lawyerRevizorro.home()}
          className={`lawyerRevizorro-nav-item ${conversationActive ? "lawyerRevizorro-nav-item--active" : ""}`}
