 ...
 * Source: lawyerRevizorro_bot_default_prompts.md — keep in sync with server/config/lawyerRevizorro.botProfilePrompts.js
 */

export const LAWYER_REVIZORRO_BOT_PROFILES = [
  { id: "admin", label: "Admin" },
  { id: "public", label: "Public" },
  { id: "partner", label: "Partner" },
  { id: "internal_sales", label: "Internal Sales" },
  { id: "external_sales", label: "External Sales" },
  { id: "supplier", label: "Supplier (LandVac)" },
];

export const LAWYER_REVIZORRO_BOT_PROFILE_PROMPTS = {
...
export function getLawyerRevizorroBotProfilePrompt(profileId) {
  return LAWYER_REVIZORRO_BOT_PROFILE_PROMPTS[profileId] ?? "";
}

export function getLawyerRevizorroBotProfileLabel(profileId) {
  return LAWYER_REVIZORRO_BOT_PROFILES.find((p) => p.id === profileId)?.label ?? profileId;
}
