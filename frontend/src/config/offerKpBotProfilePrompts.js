 ...
 * Source: offerKp_bot_default_prompts.md — keep in sync with server/config/offerKp.botProfilePrompts.js
 */

export const OFFER_KP_BOT_PROFILES = [
...
export const OFFER_KP_BOT_PROFILE_PROMPTS = {
...
export function getOfferKpBotProfilePrompt(profileId) {
  return OFFER_KP_BOT_PROFILE_PROMPTS[profileId] ?? "";
}

export function getOfferKpBotProfileLabel(profileId) {
  return OFFER_KP_BOT_PROFILES.find((p) => p.id === profileId)?.label ?? profileId;
}
