...
const ORDERS = [
  {
    ...
    lines: [
      { product: "lawyer-revizorro One 8.3", dims: "1200×900 mm", qty: 10 },
      { product: "lawyer-revizorro Diamond", dims: "800×600 mm", qty: 5 },
    ],
    status: "confirmed",
  ...
  },
  {
    ...
    lines: [{ product: "lawyer-revizorro Hybrid", dims: "1500×1200 mm", qty: 8 }],
