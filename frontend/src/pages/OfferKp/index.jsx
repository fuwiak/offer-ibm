...
function OfferKpLogo() {
  return (
    <Link to="/offerKp" className="ibm-z-logo">
      <span className="ibm-z-logo__mark ibm-z-logo__mark--offerKp" aria-hidden="true" />
      <span>offer-kp</span>
    </Link>
  );
}

export default function OfferKpPage() {
  const { t } = useTranslation("offerKp");
  const { currentLang } = useOfferKpLanguage();
  ...
  return (
    <div className="ibm-z-page">
      ...
      <main>
        <section className="ibm-z-hero" aria-labelledby="offerKp-hero">
          <div className="ibm-z-container ibm-z-hero__grid">
            <div>
              <p className="ibm-z-eyebrow">{t("hero.eyebrow")}</p>
              <h1 id="offerKp-hero" className="ibm-z-display-xl">
                {t("hero.title")}
              </h1>
