 ...
 * and stores chats with thread_id so they appear in the lawyer-revizorro UI.
 *
...
async function streamResponse({
  ...
  let contextTexts = [...pinnedContextTexts, ...searchContextTexts];
  let sources = [...pinnedSources, ...searchSources];
