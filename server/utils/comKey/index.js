...
// This keeps accidental misconfigurations of lawyer-revizorro that leave the collector port open from
...
class CommunicationKey {
  ...
  #generate() {
    ...
    this.log(
      "RSA key pair generated for signed payloads within lawyer-revizorro services."
    );
  }
