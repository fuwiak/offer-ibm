...
const OFFER_KP_HARNESS_GUIDELINES = [
  ...
  },
  {
    id: "analog-chat-list",
    when: "always",
    text: "Если пользователь спрашивает про аналоги / zamienniki / similar / «что вместо» — по блокам [Каталог · purolat.com] выведи таблицу похожих позиций (название, SKU, цена, остаток, статус exact/analog/similar). Не останавливайся на одной строке с ценой 0.00: покажи варианты с реальной ценой > 0.",
  },
  {
  ...
  },
  {
    id: "scope-no-noise",
    when: "always",
    text: "Без вступлений, извинений, эмодзи и мета-комментариев («я прочитаю каталог»). Сразу ответ по сути: цена или таблица КП.",
  },
  {
    id: "scope-stay-on-task",
    when: "always",
    text: "Не уходи от задачи пользователя: только крепёж purolat.com, цены и КП. Запрещены лекции, маркетинг, советы по другим поставщикам и темам вне заявки.",
  },
  {
    id: "scope-brevity-chat",
    when: "always",
    text: "В чате — кратко: для цены до ~15 строк; для КП — таблица и 1–3 строки итога. Не дублируй весь контекст каталога в ответе.",
  },
  {
    id: "scope-no-repeat-rules",
    when: "quote",
    text: "Не пересказывай пользователю правила из промпта и не проси «перечислите позиции», если они уже в PDF или в черновике КП.",
  },
];
