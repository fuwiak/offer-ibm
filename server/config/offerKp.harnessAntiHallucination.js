...
const CONSTRAIN_GUIDELINES = [
  ...
  "Не выдумывай цены: при отсутствии совпадения в каталоге укажи «под заказ» или оставь цену пустой (как ChatGPT), а не произвольную сумму.",
];
...
const VERIFY_GUIDELINES = [
  "Verify: перед DOCX/PDF проверь каждую строку — кол-во из PDF; цена только из ShopDB; нет цены → «под заказ» / пусто; сумма = кол-во × цена или «—».",
  "Одна строка с выдуманной ценой — исправь на «под заказ»; не отправляй документ с угаданными цифрами.",
];
