...
- Generating quotes for their end-clients using the partner's specific 
  pricing tier (Grand Compte / Revendeur / Integrateur / Public)
...
contact (replacing the default Dorothee Benamar when applicable).
...
const VALID_LAWYER_REVIZORRO_BOT_PROFILE_IDS =
  LAWYER_REVIZORRO_BOT_PROFILES.map((p) => p.id);
