...
<p align="center">
  <a href="https://avelia.com"><img src="https://github.com/Mintplex-Labs/av-elia-bot/blob/master/images/wordmark.png?raw=true" alt="AV ELIA Bot logo"></a>
</p>

<div align='center'>
<a href="https://trendshift.io/repositories/2415" target="_blank"><img src="https://trendshift.io/api/badge/repositories/2415" alt="Mintplex-Labs%2Fav-elia-bot | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>

<p align="center">
    <b>AV ELIA Bot:</b> The all-in-one AI app you were looking for.<br />
...
<p align="center">
  ...
  <a href="https://github.com/Mintplex-Labs/av-elia-bot/blob/master/LICENSE" target="_blank">
      <img src="https://img.shields.io/static/v1?label=license&message=MIT&color=white" alt="License">
  </a> |
  <a href="https://docs.avelia.com" target="_blank">
    Docs
  </a> |
   <a href="https://my.mintplexlabs.com/aio-checkout?product=avelia" target="_blank">
    Hosted Instance
  </a>
</p>
...
<p align="center">
👉 AV ELIA Bot for desktop (Mac, Windows, & Linux)! <a href="https://avelia.com/download" target="_blank"> Download Now</a>
</p>
...
![Chatting](https://github.com/Mintplex-Labs/av-elia-bot/releases/download/v1.11.2/AV ELIA Bot720p.gif)
...
AV ELIA Bot is the all-in-one AI application that lets you build a private, fully-featured ChatGPT—without compromises. Connect your favorite local or cloud LLM, ingest your documents, and start chatting in minutes. Out of the box you get built-in agents, multi-user support, vector databases, and document pipelines — no extra configuration required.

AV ELIA Bot supports multiple users as well where you can control the access and experience per user without compromising the security or privacy of the instance or your intellectual property.

## Cool features of AV ELIA Bot

- [Scheduled Tasks](https://docs.avelia.com/scheduled-jobs/overview)
- [Intelligent Skill Selection](https://docs.avelia.com/agent/intelligent-tool-selection) Enable **unlimited** tools for your models while reducing token usage by up to 80% per query
- [**No-code AI Agent builder**](https://docs.avelia.com/agent-flows/overview)
- [**Full MCP-compatibility**](https://docs.avelia.com/mcp-compatibility/overview)
- **Multi-modal support (both closed and open-source LLMs!)**
- [**Custom AI Agents**](https://docs.avelia.com/agent/custom/introduction)
- 👤 Multi-user instance support and permissioning _Docker version only_
- 🦾 Agents inside your workspace (browse the web, etc)
- 💬 [Custom Embeddable Chat widget for your website](https://github.com/Mintplex-Labs/avelia-embed/blob/main/README.md) _Docker version only_
...
- [Novita AI (chat models)](https://novita.ai/model-api/product/llm-api?utm_source=github_av-elia-bot&utm_medium=github_readme&utm_campaign=link)
- [PPIO](https://ppinfra.com?utm_source=github_av-elia-bot)
...
- [AV ELIA Bot Native Embedder](/server/storage/models/README.md) (default)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [AV ELIA Bot Built-in](https://github.com/Mintplex-Labs/av-elia-bot/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
- `embed`: Submodule for generation & creation of the [web embed widget](https://github.com/Mintplex-Labs/avelia-embed).
- `browser-extension`: Submodule for the [chrome browser extension](https://github.com/Mintplex-Labs/avelia-extension).

## 🛳 Self-Hosting

Mintplex Labs & the community maintain a number of deployment methods, scripts, and templates that you can use to run AV ELIA Bot locally. Refer to the table below to read how to deploy on your preferred environment or to automatically deploy.
...
[or set up a production AV ELIA Bot instance without Docker →](./BARE_METAL.md)
...
AV ELIA Bot by Mintplex Labs Inc contains a telemetry feature that collects anonymous usage information.

<details>
<summary><kbd>More about Telemetry & Privacy for AV ELIA Bot</kbd></summary>

### Why?

We use this information to help us understand how AV ELIA Bot is used, to help us prioritize work on new features and bug fixes, and to help us improve AV ELIA Bot's performance and stability.
...
[View all telemetry events in source code](https://github.com/search?q=repo%3AMintplex-Labs%2Fav-elia-bot%20.sendTelemetry(&type=code)
...
- `cdn.avelia.com` for pulling models from our mirror CDN. This is not tracked by telemetry and is actually useful for those in VPN restricted regions.
...
- [Contributing to AV ELIA Bot](./CONTRIBUTING.md) - How to contribute to AV ELIA Bot.
...
[![avelia contributors](https://contrib.rocks/image?repo=mintplex-labs/av-elia-bot)](https://github.com/mintplex-labs/av-elia-bot/graphs/contributors)

[![Star History Chart](https://api.star-history.com/svg?repos=mintplex-labs/av-elia-bot&type=Timeline)](https://star-history.com/#mintplex-labs/av-elia-bot&Date)
...
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mintplex-Labs/av-elia-bot&branch=render
[render-btn]: https://render.com/images/deploy-to-render-button.svg
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mintplex-Labs/av-elia-bot&branch=render
...
[elestio-deploy]: https://elest.io/open-source/avelia
[northflank-btn]: https://assets.northflank.com/deploy_to_northflank_smm_36700fb050.svg
[northflank-deploy]: https://northflank.com/stacks/deploy-avelia
